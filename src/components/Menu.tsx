      ...
      <div className='md:p-28 md:gap-y-16 md:gap-x-60 gap-10 py-16 mx-auto w-fit grid md:grid-cols-2 grid-cols-1 justify-items-center'>
        <Modal
          ...
          isOpen={modalVisibility}>
            <svg className='md:w-12 w-9 absolute right-3 top-3 cursor-pointer' onClick={()=> {setModalVisibility(false)}} enableBackground="new 0 0 128 128" id="Layer_1" version="1.1" viewBox="0 0 128 128" xmlns="http://www.w3.org/2000/svg">
        ...
        <div className='grid_child_1 relative md:w-48 w-40 border-2 rounded-2xl md:p-3 p-1.5 md:justify-self-end
          border-slate-300 bg-slate-300 hover:bg-slate-200 hover:border-slate-200'>
          <Link to='/break-sentences'><img className='cursor-pointer md:w-24 w-20 mx-auto rounded-full md:my-4 my-1 md:p-3 p-2 bg-slate-400'
           src={split} alt="Break sentence" /></Link>
          <h2 className='md:text-lg font-bold text-base'>Break Sentences</h2>
          <svg className='cursor-pointer absolute top-1.5 right-1.5 z-50 w-6 bg-slate-300 hover:bg-slate-200 rounded-full'
           onClick={()=> {
        ...
        border-slate-300 bg-slate-300 hover:bg-slate-200 hover:border-slate-200'>
          <Link to='/'><img className='cursor-pointer md:w-24 w-20 mx-auto rounded-full md:my-4 my-1 md:p-3 p-2 bg-slate-400'
           src={magnifier} alt="Break sentence" /></Link>
          <h2 className='md:text-lg font-bold text-base'>Detect Language</h2>
          <svg className='cursor-pointer absolute top-1.5 right-1.5 w-6 bg-slate-300 hover:bg-slate-200 rounded-full'
           onClick={()=> {
            setModalVisibility(true)
        ...
        <div className='grid_child_3 relative md:w-48 w-40 border-2 rounded-2xl md:p-3 p-1.5 md:justify-self-end
         border-slate-300 bg-slate-300 hover:bg-slate-200 hover:border-slate-200'>
          <Link to='/'><img className='cursor-pointer md:w-24 w-20 mx-auto rounded-full md:my-4 my-1 md:p-3 p-2 bg-slate-400'
           src={replace} alt="Break sentence" /></Link>
        ...
        <div className='grid_child_4 relative md:w-48 w-40 border-2 rounded-2xl md:p-3 p-1.5 md:justify-self-start
          border-slate-300 bg-slate-300 hover:bg-slate-200 hover:border-slate-200'>
          <Link to='/'><img className='cursor-pointer md:w-24 w-20 mx-auto rounded-full md:my-4 my-1 md:p-3 p-2 bg-slate-400'
           src={translate} alt="Break sentence" /></Link>
